...
const FocusServices = () => {
  ...
  const pt: Record<string, string> = {
    ...
    "(Still building this portfolio, but the eye for it is already there.)": "(Este portefólio ainda está a crescer, mas o olhar já cá está.)",
    ...
    "Content calendars, tone of voice, growth goals … the BTS thinking that makes the content actually work.": "Calendários, tom de voz e objetivos de crescimento: o trabalho de bastidores que faz o conteúdo resultar.",
    "Words that make sense and sound like an actual human because they were written by one": "Palavras que fazem sentido e soam humanas, porque foram escritas por uma pessoa",
    "(hello, that’s me).": "(olá, sou eu).",
    "Replies, DMs, sending memes and keeping the conversation going.": "Respostas, mensagens, memes e conversas que mantêm a comunidade ativa.",
    "Meta Ads that reach the right people.": "Anúncios Meta que chegam às pessoas certas.",
    "Creation, targeting, tracking the whole thing and making sure it works.": "Criação, segmentação, acompanhamento e otimização para garantir resultados.",
    "Numbers and stuff, but they actually make sense.": "Números e dados, mas apresentados de forma clara.",
    "I turn the data into “okay, here’s what we do next.”": "Transformo os dados em decisões claras sobre o próximo passo.",
    "Visuals for socials, campaigns and everyday brand life.": "Visuais para redes sociais, campanhas e para o dia a dia das marcas.",
    "Helping brands figure out who they are, visually speaking.": "Ajudo marcas a descobrir quem são através da sua linguagem visual.",
    "Mood, concept, identity and the whole vibe.": "Ambiente, conceito, identidade e toda a personalidade.",
    "Original content shot specifically for social.": "Conteúdo original criado especificamente para as redes sociais.",
    "Reels and TikToks that don’t feel like a chore to watch.": "Reels e TikToks que dão realmente vontade de ver.",
  };
